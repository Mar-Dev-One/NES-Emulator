...
Instruction opcode_table[256] = {
    ...
    /*0x04*/ {"???",NOP,IMP,3},{"ORA",ORA,ZP0,3},{"ASL",ASL,ZP0,5},{"???",XXX,IMP,5},
    /*0x08*/ {"PHP",PHP,IMP,3},{"ORA",ORA,IMM,2},{"ASL",ASL,IMP,2},{"???",XXX,IMP,2},
    /*0x0C*/ {"???",NOP,IMP,4},{"ORA",ORA,ABS,4},{"ASL",ASL,ABS,6},{"???",XXX,IMP,6},
    /*0x10*/ {"BPL",BPL,REL,2},{"ORA",ORA,IZY,5},{"???",XXX,IMP,2},{"???",XXX,IMP,8},
    /*0x14*/ {"???",NOP,IMP,4},{"ORA",ORA,ZPX,4},{"ASL",ASL,ZPX,6},{"???",XXX,IMP,6},
    /*0x18*/ {"CLC",CLC,IMP,2},{"ORA",ORA,ABY,4},{"???",NOP,IMP,2},{"???",XXX,IMP,7},
    /*0x1C*/ {"???",NOP,IMP,4},{"ORA",ORA,ABX,4},{"ASL",ASL,ABX,7},{"???",XXX,IMP,7},
    ...
    /*0x34*/ {"???",NOP,IMP,4},{"AND",AND,ZPX,4},{"ROL",ROL,ZPX,6},{"???",XXX,IMP,6},
    /*0x38*/ {"SEC",SEC,IMP,2},{"AND",AND,ABY,4},{"???",NOP,IMP,2},{"???",XXX,IMP,7},
    /*0x3C*/ {"???",NOP,IMP,4},{"AND",AND,ABX,4},{"ROL",ROL,ABX,7},{"???",XXX,IMP,7},
    /*0x40*/ {"RTI",RTI,IMP,6},{"EOR",EOR,IZX,6},{"???",XXX,IMP,2},{"???",XXX,IMP,8},
    /*0x44*/ {"???",NOP,IMP,3},{"EOR",EOR,ZP0,3},{"LSR",LSR,ZP0,5},{"???",XXX,IMP,5},
    ...
    /*0x54*/ {"???",NOP,IMP,4},{"EOR",EOR,ZPX,4},{"LSR",LSR,ZPX,6},{"???",XXX,IMP,6},
    /*0x58*/ {"CLI",CLI,IMP,2},{"EOR",EOR,ABY,4},{"???",NOP,IMP,2},{"???",XXX,IMP,7},
    /*0x5C*/ {"???",NOP,IMP,4},{"EOR",EOR,ABX,4},{"LSR",LSR,ABX,7},{"???",XXX,IMP,7},
    /*0x60*/ {"RTS",RTS,IMP,6},{"ADC",ADC,IZX,6},{"???",XXX,IMP,2},{"???",XXX,IMP,8},
    /*0x64*/ {"???",NOP,IMP,3},{"ADC",ADC,ZP0,3},{"ROR",ROR,ZP0,5},{"???",XXX,IMP,5},
    ...
    /*0x74*/ {"???",NOP,IMP,4},{"ADC",ADC,ZPX,4},{"ROR",ROR,ZPX,6},{"???",XXX,IMP,6},
    /*0x78*/ {"SEI",SEI,IMP,2},{"ADC",ADC,ABY,4},{"???",NOP,IMP,2},{"???",XXX,IMP,7},
    /*0x7C*/ {"???",NOP,IMP,4},{"ADC",ADC,ABX,4},{"ROR",ROR,ABX,7},{"???",XXX,IMP,7},
    /*0x80*/ {"???",NOP,IMP,2},{"STA",STA,IZX,6},{"???",XXX,IMP,2},{"???",XXX,IMP,6},
    /*0x84*/ {"STY",STY,ZP0,3},{"STA",STA,ZP0,3},{"STX",STX,ZP0,3},{"???",XXX,IMP,3},
    /*0x88*/ {"DEY",DEY,IMP,2},{"???",NOP,IMP,2},{"TXA",TXA,IMP,2},{"???",XXX,IMP,2},
    ...
    /*0xC0*/ {"CPY",CPY,IMM,2},{"CMP",CMP,IZX,6},{"???",XXX,IMP,2},{"???",XXX,IMP,8},
    ...
    /*0xD4*/ {"???",NOP,IMP,4},{"CMP",CMP,ZPX,4},{"DEC",DEC,ZPX,6},{"???",XXX,IMP,6},
    /*0xD8*/ {"CLD",CLD,IMP,2},{"CMP",CMP,ABY,4},{"???",NOP,IMP,2},{"???",XXX,IMP,7},
    /*0xDC*/ {"???",NOP,IMP,4},{"CMP",CMP,ABX,4},{"DEC",DEC,ABX,7},{"???",XXX,IMP,7},
    /*0xE0*/ {"CPX",CPX,IMM,2},{"SBC",SBC,IZX,6},{"???",XXX,IMP,2},{"???",XXX,IMP,8},
    ...
    /*0xF4*/ {"???",NOP,IMP,4},{"SBC",SBC,ZPX,4},{"INC",INC,ZPX,6},{"???",XXX,IMP,6},
    /*0xF8*/ {"SED",SED,IMP,2},{"SBC",SBC,ABY,4},{"???",NOP,IMP,2},{"???",XXX,IMP,7},
    /*0xFC*/ {"???",NOP,IMP,4},{"SBC",SBC,ABX,4},{"INC",INC,ABX,7},{"???",XXX,IMP,7},
};
